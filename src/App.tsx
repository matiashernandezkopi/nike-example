...
>
  <h1 className="font-bold text-lg tracking-wide cursor-pointer">NIKI SPORT</h1>
  ...
  >
    ...
    <button
      id="login-btn"
      className=" border border-[#0077ff] text-[#0077ff] px-5 py-1.5 rounded-full font-semibold cursor-pointer"
    >
      Login
    </button>
  </nav>
  ...
  >
    <button id="close-menu" className="text-3xl mb-4 text-gray-700">×</button>

    <a href="#" className="mobile-item border-b pb-2">Home</a>
    <a href="#" className="mobile-item border-b pb-2">Product</a>
    <a href="#" className="mobile-item border-b pb-2">Contact</a>
